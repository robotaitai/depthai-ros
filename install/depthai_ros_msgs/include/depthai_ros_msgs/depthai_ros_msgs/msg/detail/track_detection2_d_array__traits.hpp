...
inline void to_flow_style_yaml(
  const TrackDetection2DArray & msg,
  std::ostream & out)
{
  out << "{";
  // member: header
...
inline std::string to_yaml(const TrackDetection2DArray & msg, bool use_flow_style = false)
{
...
inline void to_yaml(
  const depthai_ros_msgs::msg::TrackDetection2DArray & msg,
  std::ostream & out, size_t indentation = 0)
{
...
inline std::string to_yaml(const depthai_ros_msgs::msg::TrackDetection2DArray & msg)
{
